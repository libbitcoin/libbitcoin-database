...
BOOST_AUTO_TEST_CASE(query_archive_read__is_tx_segregated__always__expected)
{
    ...
    BOOST_CHECK( query.is_tx_segregated(1));
    BOOST_CHECK(!query.is_tx_segregated(2));
}
...
BOOST_AUTO_TEST_CASE(query_archive_read__is_block_segregated__always__expected)
{
    ...
    BOOST_CHECK( query.is_block_segregated(1));
    BOOST_CHECK(!query.is_block_segregated(2));
}
...
BOOST_AUTO_TEST_CASE(query_archive_read__get_tx_position__strong__expected)
{
    ...
    BOOST_CHECK_EQUAL(query.get_position_tx(0, 0), 0u);
    BOOST_CHECK_EQUAL(query.get_position_tx(1, 0), 1u);
    BOOST_CHECK_EQUAL(query.get_position_tx(2, 0), 2u);
    BOOST_CHECK_EQUAL(query.get_position_tx(2, 1), 3u);
...
BOOST_AUTO_TEST_CASE(query_archive_read__get_position_tx__always__expected)
{
    ...
    BOOST_CHECK_EQUAL(query.get_position_tx(2, 1), 3u);
    BOOST_CHECK_EQUAL(query.get_position_tx(3, 0), 4u);
    BOOST_CHECK(query.get_position_tx(3, 1).is_terminal());
...
BOOST_AUTO_TEST_CASE(query_archive_read__get_input__genesis__expected)
{
    ...
    BOOST_CHECK(*input == *query.get_input(point, false));
    BOOST_CHECK(input->witness() == *query.get_witness(point));
...
BOOST_AUTO_TEST_CASE(query_archive_read__get_output__genesis__expected)
{
    ...
    BOOST_CHECK(*output == *query.get_output(0));
    BOOST_CHECK(*output == *query.get_output(query.to_tx(tx->hash(false)), 0u));
    BOOST_CHECK(*output == *query.get_output(query.to_output(tx->hash(false), 0u)));
