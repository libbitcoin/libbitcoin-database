...
////    const auto null_key = table::point::compose(null_hash, 0x00ffffff_u32);
////    BOOST_REQUIRE(instance.put_link(link, null_key, table::point::record{}));
////    BOOST_REQUIRE_EQUAL(link, 0u);
////    const auto key = table::point::compose(hash, 0x00000042u);
