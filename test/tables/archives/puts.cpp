...
BOOST_AUTO_TEST_CASE(puts__put__get__expected)
{
    ...
    BOOST_REQUIRE(!instance.put(expected0).is_terminal());
    BOOST_REQUIRE(!instance.put(expected1).is_terminal());
    BOOST_REQUIRE(!instance.put(expected2).is_terminal());
    BOOST_REQUIRE(!instance.put(expected3).is_terminal());
