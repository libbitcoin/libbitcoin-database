...
BOOST_AUTO_TEST_CASE(header__verify__uncreated__false)
{
    data_chunk data;
    test::storage store{ data };
    header head{ store, buckets };
...
BOOST_AUTO_TEST_CASE(header__verify__created__false)
{
    data_chunk data;
    test::storage store{ data };
    header head{ store, buckets };
...
BOOST_AUTO_TEST_CASE(header__get_body_count__created__zero)
{
    data_chunk data;
    test::storage store{ data };
    header head{ store, buckets };
...
BOOST_AUTO_TEST_CASE(header__set_body_count__get__expected)
{
    data_chunk data;
    test::storage store{ data };
    header head{ store, buckets };
...
BOOST_AUTO_TEST_CASE(header__index__null_key__expected)
{
...
BOOST_AUTO_TEST_CASE(header__head__link__terminal)
{
    test::storage store;
    header head{ store, buckets };
    BOOST_REQUIRE(head.create());
...
BOOST_AUTO_TEST_CASE(header__head__key__terminal)
{
    constexpr key null_key{};
...
BOOST_AUTO_TEST_CASE(header__push__link__terminal)
{
    test::storage store;
    header head{ store, buckets };
    BOOST_REQUIRE(head.create());
...
BOOST_AUTO_TEST_CASE(header__push__key__terminal)
{
    test::storage store;
    header head{ store, buckets };
    BOOST_REQUIRE(head.create());
