...
struct query_conversion_setup_fixture
{
    DELETE4(query_conversion_setup_fixture);
    BC_PUSH_WARNING(NO_THROW_IN_NOEXCEPT)

        query_conversion_setup_fixture() NOEXCEPT
    {
...
BOOST_FIXTURE_TEST_SUITE(query_conversion_tests, query_conversion_setup_fixture)
...
BOOST_AUTO_TEST_CASE(query_conversion__to_candidate__always__expected)
{
    settings settings{};
    ...
    // key-link conversion of actual candidates.
...
BOOST_AUTO_TEST_CASE(query_conversion__to_confirmed__always__expected)
{
    settings settings{};
    settings.dir = TEST_DIRECTORY;
    test::chunk_store store{ settings };
    ...
    // key-link conversion of actual confirmeds.
...
BOOST_AUTO_TEST_CASE(query_conversion__to_header__always__expected)
{
    settings settings{};
    settings.dir = TEST_DIRECTORY;
    test::chunk_store store{ settings };
...
BOOST_AUTO_TEST_CASE(query_conversion__to_point__null_points__empty_points_table)
{
    settings settings{};
    settings.dir = TEST_DIRECTORY;
    test::chunk_store store{ settings };
...
BOOST_AUTO_TEST_CASE(query_conversion__to_point__points__expected)
{
    settings settings{};
    settings.dir = TEST_DIRECTORY;
    test::chunk_store store{ settings };
...
BOOST_AUTO_TEST_CASE(query_conversion__to_tx__txs__expected)
{
    settings settings{};
    settings.dir = TEST_DIRECTORY;
    test::chunk_store store{ settings };
...
BOOST_AUTO_TEST_CASE(query_conversion__to_input_tx__to_input__expected)
{
    settings settings{};
...
BOOST_AUTO_TEST_CASE(query_conversion__to_output_tx__to_output__expected)
{
    settings settings{};
    settings.input_buckets = 5;
    settings.dir = TEST_DIRECTORY;
...
BOOST_AUTO_TEST_CASE(query_conversion__to_prevout_tx__to_prevout__expected)
{
    settings settings{};
    ...
    BOOST_REQUIRE_EQUAL(query.to_prevout(0x64 + 3 * 29), 82u); // block1a:0:0 (second serialized tx, first output)
    BOOST_REQUIRE_EQUAL(query.to_prevout(0x64 + 4 * 29), 90u); // block1a:0:1 (second serialized tx, second output)
    ...
    (
        "00000000""00""ff00f2052a01000000434104678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5fac"
        "01000000""00""180179" // [82]
        "01000000""01""2a017a" // [90]
        "02000000""00""810179"
        "03000000""00""810179"
    );
...
BOOST_AUTO_TEST_CASE(query_conversion__to_strong_by__set_strong__expected)
{
    settings settings{};
    settings.dir = TEST_DIRECTORY;
    test::chunk_store store{ settings };
...
BOOST_AUTO_TEST_CASE(query_conversion__to_transactions__txs__expected)
{
    settings settings{};
    settings.dir = TEST_DIRECTORY;
    test::chunk_store store{ settings };
