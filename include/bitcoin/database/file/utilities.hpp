...
BCD_API code clear_directory_ex(const path& directory) NOEXCEPT;

/// Create directory, false if existed/error.
BCD_API bool create_directory(const path& directory) NOEXCEPT;
BCD_API code create_directory_ex(const path& directory) NOEXCEPT;
...
BCD_API code size_ex(size_t& out, int file_descriptor) NOEXCEPT;

/// File size from name.
BCD_API bool size(size_t& out, const path& filename) NOEXCEPT;
BCD_API code size_ex(size_t& out, const path& filename) NOEXCEPT;

/// Volume space from path.
BCD_API bool space(size_t& out, const path& filename) NOEXCEPT;
BCD_API code space_ex(size_t& out, const path& filename) NOEXCEPT;
