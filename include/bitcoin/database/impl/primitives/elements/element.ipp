 ...
 */
#ifndef LIBBITCOIN_DATABASE_PRIMITIVES_ELEMENTS_ELEMENT_IPP
#define LIBBITCOIN_DATABASE_PRIMITIVES_ELEMENTS_ELEMENT_IPP
...
TEMPLATE
memory_ptr CLASS::get(size_t byte_offset) const NOEXCEPT
{
    auto memory = get();
